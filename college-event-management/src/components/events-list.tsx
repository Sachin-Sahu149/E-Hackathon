...
type Event = {
    ...
    description: string;
    category: string;
    status: "pending" | "approved"; // ✅ Strictly restrict status
    participants: string[];
  };
  


  const mockEvents: Event[] = [  // ✅ Explicitly setting type
    {
      id: "1",
      ...
      category: "workshop",
      status: "approved", // ✅ Matches "approved" | "pending"
